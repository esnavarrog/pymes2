...
class PopsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pop" do
    assert_difference('Pop.count') do
      post pops_url, params: { pop: { avatar: @pop.avatar, descripcion: @pop.descripcion, destacado: @pop.destacado, list_id: @pop.list_id, precio: @pop.precio, title: @pop.title } }
    end
  ...
  test "should update pop" do
    patch pop_url(@pop), params: { pop: { avatar: @pop.avatar, descripcion: @pop.descripcion, destacado: @pop.destacado, list_id: @pop.list_id, precio: @pop.precio, title: @pop.title } }
